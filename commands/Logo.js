...
king({
  ...
  try {
    if (!_0x17b8db || _0x17b8db == '') {
      _0x1bce4a("*_Example : * " + _0xdbce5a + "naruto FLASH-MD");
      return;
    }
    _0x1bce4a("*FLASH-MD is Processing Your Request...*");
...
king({
  ...
  try {
    ...
    _0x23d127("*FLASH-MD is processing your request...*");
...
king({
  ...
  try {
    if (!_0x1cc29f || _0x1cc29f == '') {
      _0x3d04bb(_0x935ff1 + "gold Flash-MD");
      return;
    }
...
king({
  ...
  try {
    if (!_0x173395 || _0x173395 == '') {
      _0x45e8bf(_0x305516 + "arena Flash-MD");
      return;
    }
...
king({
  ...
  try {
    if (!_0x4b58e7 || _0x4b58e7 == '') {
      _0x1db70e(_0x494606 + "incandescent Flash-MD");
      return;
    }
...
king({
  ...
  try {
    if (!_0x6efe13 || _0x6efe13 == '') {
      _0x35540f(_0x1b0b42 + "child Flash-MD");
      return;
    }
...
king({
  ...
  try {
    if (!_0x139bd2 || _0x139bd2 == '') {
      _0x132248(_0x5effd2 + "typo Flash-MD");
      return;
    }
...
king({
  ...
  try {
    if (!_0xfe79e0 || _0xfe79e0 == '') {
      _0x2c714c(_0x46fa4e + "light Flash-MD");
      return;
    }
...
king({
  ...
  try {
    if (!_0x3aad7c || _0x3aad7c == '') {
      _0x550e81(_0x586e09 + "steel Flash-MD");
      return;
    }
...
king({
  ...
  try {
    if (!_0x1a407a || _0x1a407a == '') {
      _0x4195f9(_0x155f29 + "sunlight Flash-MD");
      return;
    }
